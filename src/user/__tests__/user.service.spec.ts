...
} from '../__mocks__/updatePasswordUser.mock';
...
describe('UserService', () => {
  ...
  it('should return error in update password invalid', async () => {
    expect(
      service.updatePasswordUser(updatePasswordUserInvalidMock, UserEntityMock.id),
    ).rejects.toThrow();
  });
